...
export default function ResumePreview({ data }: { data: any }) {
  if (!data) return null;
  return (
    <div className="bg-white max-w-[800px] mx-auto p-10 rounded-xl shadow-xl border border-gray-200 font-sans text-gray-900 print:shadow-none print:border-none">
      {/* Header */}
      ...
      {/* Skills, Certifications, Projects, Awards, Languages, Social */}
